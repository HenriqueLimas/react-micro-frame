...
## What's Been Tried
- Baseline on 2026-07-20: statements 83.28%, branches 69.51%, functions 85.36%, lines 84.88% (30 tests). The main gaps are client lifecycle/error branches, React context/error-boundary behavior, error constructors, and server failure/parser-state branches.
